<?
$moduleName = 'Allcorp3Medc';
CModule::AddAutoloadClasses(
	'aspro.allcorp3medc',
	array(
		"allcorp3medc" => "install/index.php",
		...
		"C{$moduleName}ChartTable" => "classes/general/C{$moduleName}ChartTable.php",
...
if(!CJSCore::IsExtRegistered('aspro_core_condtree')){
	CJSCore::RegisterExt(
		'aspro_core_condtree',
		array(
			'js' => '/bitrix/js/aspro.allcorp3medc/core_tree.js',
			'css' => '/bitrix/css/aspro.allcorp3medc/catalog_cond.css',
			'lang' => '/bitrix/modules/aspro.allcorp3medc/lang/'.LANGUAGE_ID.'/lib/js_core_tree.php',
