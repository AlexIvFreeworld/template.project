...
class ExtComponentParameter
{
	...
	const RELATION_BLOCK_PRICES = 'prices';
	const RELATION_BLOCK_SCHEDULE = 'schedule';
	...
	const ORDER_BLOCK_PRICES = 'prices';
	const ORDER_BLOCK_SCHEDULE = 'schedule';
	...
	private static function getCodeRelationBlocks()
	{
		return [
			...
			self::RELATION_BLOCK_PRICES,
			self::RELATION_BLOCK_SCHEDULE,
		];
	}
	...
	private static function getCodeOrderBlocks()
	{
		return [
			...
			self::ORDER_BLOCK_PRICES,
			self::ORDER_BLOCK_SCHEDULE,
		];
	}
