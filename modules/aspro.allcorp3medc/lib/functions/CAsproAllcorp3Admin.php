...
class CAsproAllcorp3Admin{
	...
	private static $moduleClass = 'CAllcorp3Medc';
	...
	public function setOption($optionCode, $arOption, $optionListKey, &$newVal){
		...
		elseif($arOption["TYPE"] == "file"){
			...
			$newVal = Solution::unserialize(Option::get(self::MODULE_ID, $optionCode, $arValueDefault, $this->siteID));
			if(
