<?
namespace Aspro\Allcorp3Medc;
use	CAllcorp3Medc as Solution,
	CAllcorp3MedcCache as Cache,
	CAllcorp3MedcCondition as Condition,
	\Aspro\Allcorp3Medc\Property\CustomFilter,
	\Bitrix\Main\Web\Json;

class MarketingPopup{
	const ALL_USERS_GROUP_ID = 2;
	const IBLOCK_TYPE = 'aspro_allcorp3medc_adv';
	const IBLOCK_CODE = 'aspro_allcorp3medc_marketings';
			...
			if($this->iblockId){
				...
				if($arRulesTmp = Cache::CIBLockElement_GetList(
					...
					if($arRulesIDs){
						...
						$cachePath = '/CAllcorp3MedcCache/iblock/CIBlockElement_GetList/'.$cacheTag.'/';
