<?
namespace Aspro\Allcorp3Medc\CRM;
...
class Helper {
    const FORM_LEAD_REF_VALUE = 'form:aspro-allcorp3medc';
    const ORDER_LEAD_REF_VALUE = 'order:aspro-allcorp3medc';
    ...
    public static function getSendingFormResult(int $resultId, string $siteId) :array {
        ...
        $value = Solution::unserialize($value);
        if (!is_array($value)) {
            $value = [];
        }
