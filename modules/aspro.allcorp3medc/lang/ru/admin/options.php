...
$MESS["ASPRO_ALLCORP_3_NO_SITE_INSTALLED"] = 'Не найдено сайтов с установленным решением &laquo;Аспро: Корпоративный сайт 3.0&raquo;<br />
<input type="button" value="Установить" style="margin-top: 10px;" onclick="document.location.href=\'/bitrix/admin/wizard_install.php?lang=ru&wizardName=aspro:allcorp3&#SESSION_ID#\'">';
...
$MESS["FRONT_PARTNERS_GROUP"] = "Блок «Производители»";
...
$MESS["CATALOG_GALERY_GROUP"] = "Галерея картинок у товаров в списке";
$MESS["SEARCH_VIEW_TYPE_GROUP"] = "Поиск";
$MESS["MENU_TYPE_VIEW_GROUP"] = "Меню на внутренних страницах";
$MESS["SERVICES_PAGE_GROUP"] = "Шаблоны";
$MESS["TARIFFS_PAGE_GROUP"] = "Шаблоны";
...
$MESS["EXPRESSION_ADDTOBASKET_GROUP"] = "Кнопки товаров";
...
$MESS['FORMS_OPTIONS_GROUP'] = 'Настройки форм';
$MESS["EXPRESS_BUTTON_GROUP"] = "Кнопка в шапке и меню";

$MESS["SITE_SELECTOR_GROUP"] = "Переключатель сайтов";

$MESS["SHAREPRESET_TITLE"] = "Поделиться настройками";
$MESS["SHAREPRESET_EXPORT_TITLE"] = "Экспорт настроек";
$MESS["SHAREPRESET_EXPORT_BLOCKS_TOGGLE"] = 'Выбрано #COUNT# из #ALLCOUNT# групп настроек';
$MESS["SHAREPRESET_EXPORT_BLOCKS_SELECT_ALL"] = 'Выделить все';
$MESS["SHAREPRESET_EXPORT_BLOCKS_RESET_ALL"] = 'Очистить';
$MESS["SHAREPRESET_EXPORT_FILE"] = "В файл";
$MESS["SHAREPRESET_EXPORT_FILE_BUTTON"] = "Скачать файл настроек";
$MESS["SHAREPRESET_IMPORT_TITLE"] = "Импорт настроек";
$MESS["SHAREPRESET_IMPORT_LINK"] = "По ссылке";
$MESS["SHAREPRESET_IMPORT_FILE"] = "Из файла";
$MESS["SHAREPRESET_IMPORT_APPLY_BUTTON"] = "Применить";
$MESS["SHAREPRESET_IMPORT_NOTE"] = "Не экспортируются и не импортируются настройки:<ul><li>индентификаторы, привязки к инфоблокам и прочим сущностям,</li><li>включаемые области (адрес, расписание работы, код счетчиков и пр.),</li><li>с текстовыми значениями (номера телефонов, ссылки, выражения и названия, API токены, ключи и пр.),</li><li>файлы.</li></ul>";

$MESS["DROPDOWN_CONTACTS"] = "Состав выпадающего списка контактной информации";
?>