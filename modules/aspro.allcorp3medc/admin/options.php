...
$moduleAdminClass = "\Aspro\Allcorp3Medc\Functions\CAsproAllcorp3Admin";
...
if($RIGHT >= "R"){
	...
	CJSCore::Init(["jquery", "iconset", "regionphone"]);

	$GLOBALS['APPLICATION']->AddHeadScript("/bitrix/js/".Solution::moduleID."/spectrum.js");
	$GLOBALS['APPLICATION']->AddHeadScript("/bitrix/js/".Solution::moduleID."/jquery.splendid.textchange.js");
