<?
if(!defined('ASPRO_ALLCORP3MEDC_MODULE_ID'))
	define('ASPRO_ALLCORP3MEDC_MODULE_ID', 'aspro.allcorp3medc');


class CVKAllcorp3Medc{
	const MODULE_ID = ASPRO_ALLCORP3MEDC_MODULE_ID;
