...
$FORM_SID = "aspro_allcorp3medc_resume_".WIZARD_SITE_ID;
...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => '#DEFAULT_EMAIL_FROM#', "EMAIL_TO" => "#EMAIL#", "SUBJECT" => GetMessage("NEW_RESUME_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_RESUME_EMAIL_TEXT"), "BODY_TYPE" => "html");
...
if($form_id){
	...
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("RESUME_FORM_QUESTION_5"), "TITLE_TYPE" => "text", "SID" => "MESSAGE", "C_SORT" => 500, "ADDITIONAL" => "N", "REQUIRED" => "N", "arANSWER" => $arANSWER);
	CFormField::Set($arFields);

	$arANSWER = array();
	$arANSWER[] = array("MESSAGE" => " ", "C_SORT" => 100, "ACTIVE" => "Y", "FIELD_TYPE" => "file", "FIELD_PARAM" => "");
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("RESUME_FORM_QUESTION_6"), "TITLE_TYPE" => "text", "SID" => "FILE", "C_SORT" => 600, "ADDITIONAL" => "N", "REQUIRED" => "N", "arANSWER" => $arANSWER);
	CFormField::Set($arFields);
