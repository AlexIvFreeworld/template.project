...
Option::set("aspro.allcorp3medc", "EXPRESS_BUTTON_FORM", 'aspro_allcorp3medc_question', WIZARD_SITE_ID);
...
$imgID = Solution::unserialize(Option::get("aspro.allcorp3medc", "BGFILEASPRO_ALLCORP3MEDC_CALLBACK_FORM", serialize([]), WIZARD_SITE_ID));
$imgID2 = Solution::unserialize(Option::get("aspro.allcorp3medc", "BGFILEASPRO_ALLCORP3MEDC_CALLBACK_FORM_ACTIVE", serialize([]), WIZARD_SITE_ID));
