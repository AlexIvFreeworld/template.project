...
//remove all options
Option::delete('aspro.allcorp3medc', ['site_id' => WIZARD_SITE_ID]);

if(Option::get("main", "upload_dir") == "")
	Option::set("main", "upload_dir", "upload");


if(Option::get("aspro.allcorp3medc", "wizard_installed", "N") == 'N'){
	...
	Option::set("aspro.allcorp3medc", "wizard_installed", "Y");
}
...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	$arNewUrlRewrite = array(
		...
		array(
			"CONDITION" => "#^".WIZARD_SITE_DIR."company/nadzor/#",
			"RULE" => "",
			"ID" => "bitrix:news",
			"PATH" => WIZARD_SITE_DIR."company/nadzor/index.php",
		),
		array(
...
$phones = Option::get('aspro.allcorp3medc', "HEADER_PHONES", $iCountPhones, WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "HEADER_PHONES", $iCountPhones, WIZARD_SITE_ID);
if($iCountPhones)
{
	foreach($arPhones as $key => $value)
	{
		Option::set('aspro.allcorp3medc', "HEADER_PHONES_array_PHONE_VALUE_".$key, $value, WIZARD_SITE_ID);
		$href = 'tel:'.preg_replace('/[^\d]/', '', $value);
		Option::set('aspro.allcorp3medc', "HEADER_PHONES_array_PHONE_HREF_".$key, $href, WIZARD_SITE_ID);
	}
}
else
{
	if($phones)
	{
		for($i = 0; $i <= $phones; ++$i)
		{
			Option::delete('aspro.allcorp3medc', array("name" => "HEADER_PHONES_array_PHONE_VALUE_".$i, "site_id" => WIZARD_SITE_ID));
			Option::delete('aspro.allcorp3medc', array("name" => "HEADER_PHONES_array_PHONE_HREF_".$i, "site_id" => WIZARD_SITE_ID));
		}
	}
}
...
// socials
Option::set('aspro.allcorp3medc', "SOCIAL_VK", $wizard->GetVar("shopVk"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_FACEBOOK", $wizard->GetVar("shopFacebook"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_TWITTER", $wizard->GetVar("shopTwitter"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_YOUTUBE", $wizard->GetVar("shopYoutube"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_INSTAGRAM", $wizard->GetVar("shopInstagram"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_TELEGRAM", $wizard->GetVar("shopTelegram"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_ODNOKLASSNIKI", $wizard->GetVar("shopOdnoklassniki"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_GOOGLEPLUS", $wizard->GetVar("shopGooglePlus"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_MAIL", $wizard->GetVar("shopMailRu"), WIZARD_SITE_ID);
//Option::set('aspro.allcorp3medc', "SOCIAL_VIBER", $wizard->GetVar("shopViber"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_VIBER", '', WIZARD_SITE_ID);
// Option::set('aspro.allcorp3medc', "SOCIAL_WHATS", $wizard->GetVar("shopWhats"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_WHATS", '', WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_TIKTOK", $wizard->GetVar("shopTikTok"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_ZEN", $wizard->GetVar("shopZen"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_PINTEREST", $wizard->GetVar("shopPinterest"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_SNAPCHAT", $wizard->GetVar("shopSnapchat"), WIZARD_SITE_ID);
Option::set('aspro.allcorp3medc', "SOCIAL_LINKEDIN", $wizard->GetVar("shopLinkedin"), WIZARD_SITE_ID);
