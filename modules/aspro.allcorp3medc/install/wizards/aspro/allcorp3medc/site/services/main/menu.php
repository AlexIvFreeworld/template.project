...
if(!isset($arMenuTypes['topest']))
	$arMenuTypes['topest'] = Loc::getMessage('WIZ_MENU_TOPEST_DEFAULT');
...
if(!isset($arMenuTypes['bottom5']))
	$arMenuTypes['bottom5'] = Loc::getMessage('WIZ_MENU_BOTTOM5');
if(!isset($arMenuTypes['bottom6']))
	$arMenuTypes['bottom6'] = Loc::getMessage('WIZ_MENU_BOTTOM6');
