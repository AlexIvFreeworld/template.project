...
$FORM_SID = "aspro_allcorp3medc_director_".WIZARD_SITE_ID;
...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => '#DEFAULT_EMAIL_FROM#', "EMAIL_TO" => '#DEFAULT_EMAIL_FROM#', "SUBJECT" => GetMessage("NEW_DIRECTOR_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_DIRECTOR_EMAIL_TEXT"), "BODY_TYPE" => "html");
