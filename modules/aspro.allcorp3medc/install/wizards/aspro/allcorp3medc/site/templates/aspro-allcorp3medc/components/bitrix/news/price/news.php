...
$arItemFilter = CAllcorp3Medc::GetCurrentSectionElementFilter($arResult["VARIABLES"], $arParams, false);
$arSubSectionFilter = CAllcorp3Medc::GetCurrentSectionSubSectionFilter($arResult["VARIABLES"], $arParams, false);
...
$arSubSections = CAllcorp3MedcCache::CIBlockSection_GetList(array("CACHE" => array("TAG" => CAllcorp3MedcCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "Y")), $arSubSectionFilter, false, array("ID"));
...
<?else:?>
	...
	<?$sViewElementTemplate = $arParams["SECTIONS_TYPE_VIEW"];?>
