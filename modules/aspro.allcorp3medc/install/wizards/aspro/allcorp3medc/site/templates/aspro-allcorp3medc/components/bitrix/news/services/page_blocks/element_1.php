...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"T_PRICES" => ($arParams["T_PRICES"] ? $arParams["T_PRICES"] : GetMessage("T_PRICES")),
		"SHOW_DOPS" => $arParams["SHOW_DOPS"],
		"T_DOPS" => ($arParams["T_DOPS"] ? $arParams["T_DOPS"] : GetMessage("T_DOPS")),
		"TAB_DOPS_NAME" => $arParams["TAB_DOPS_NAME"],
		"FORM_ID_ORDER_SERVISE" => ($arParams["FORM_ID_ORDER_SERVISE"] ? $arParams["FORM_ID_ORDER_SERVISE"] : "aspro_allcorp3medc_order_services"),
		...
		"SALE_IBLOCK_ID" => ($arParams["SALE_IBLOCK_ID"] ? $arParams["SALE_IBLOCK_ID"] : CAllcorp3MedcCache::$arIBlocks[SITE_ID]["aspro_allcorp3medc_content"]["aspro_allcorp3medc_sales"][0]),
		...
		"DETAIL_BLOCKS_ORDER" => ($arParams["DETAIL_BLOCKS_ORDER"] ? $arParams["DETAIL_BLOCKS_ORDER"] : 'tabs,big_gallery,services,sale,news,articles,licenses,staff,partners,vacancy,goods,comments'),
		...
		"DETAIL_BLOCKS_ALL_ORDER" => ($arParams["DETAIL_BLOCKS_ALL_ORDER"] ? $arParams["DETAIL_BLOCKS_ALL_ORDER"] : 'desc,char,reviews,big_gallery,video,services,sale,news,articles,docs,licenses,staff,faq,partners,vacancy,goods,custom_tab,comments'),
