...
<div class="left_block">
	<div class="sticky-block sticky-block--show-<?=CAllcorp3Medc::GetFrontParametrValue('STICKY_SIDEBAR')?>">
		<?if($isCabinet):?>
		...
		<div class="sidearea">
			...
			<?CAllcorp3Medc::get_banners_position('SIDE');?>
			<?/*$APPLICATION->IncludeComponent(
				"bitrix:news.list",
				"tizers2",
				array(
					"IBLOCK_TYPE" => "aspro_allcorp3medc_content",
					"IBLOCK_ID" => CAllcorp3MedcCache::$arIBlocks[SITE_ID]["aspro_allcorp3medc_content"]["aspro_allcorp3medc_front_tizers"][0],
					"NEWS_COUNT" => "100",
					"SORT_BY1" => "SORT",
					"SORT_ORDER1" => "ASC",
					"SORT_BY2" => "ID",
