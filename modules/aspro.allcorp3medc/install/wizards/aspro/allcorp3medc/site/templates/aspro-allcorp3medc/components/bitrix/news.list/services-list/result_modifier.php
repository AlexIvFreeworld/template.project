...
if($bItemsTypeElements){
	...
	foreach($arResult['ITEMS'] as $key => &$arItem){
		...
		$arItem['FORMAT_PROPS'] = CAllcorp3Medc::PrepareItemProps($arItem['DISPLAY_PROPERTIES']);

		CAllcorp3Medc::getFieldImageData($arItem, array('PREVIEW_PICTURE'));
	...
	if($arSectionsIDs){
		$arSections = CAllcorp3MedcCache::CIBLockSection_GetList(
			array(
				'SORT' => 'ASC',
				'NAME' => 'ASC',
				'CACHE' => array(
	...
	if($arParams['PARENT_SECTION']){
		$arParentSection = CAllcorp3MedcCache::CIBLockSection_GetList(
			array(
				'SORT' => 'ASC', 
				'NAME' => 'ASC', 
				'CACHE' => array(
	...
	$arResult['SECTIONS'] = CAllcorp3MedcCache::CIBLockSection_GetList(
		array(
			'SORT' => 'ASC', 
			'NAME' => 'ASC', 
			'CACHE' => array(
	...
	if($arResult['SECTIONS']){
		...
		foreach($arResult['SECTIONS'] as $key => $arSection){
			...
			CAllcorp3Medc::getFieldImageData($arResult['SECTIONS'][$key], array('PICTURE'), 'SECTION');
		}
