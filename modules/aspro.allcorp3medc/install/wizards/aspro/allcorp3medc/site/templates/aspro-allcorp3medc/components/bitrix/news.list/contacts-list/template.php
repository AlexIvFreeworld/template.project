										...
										<div class="contacts-list__item-col contacts-list__item-col--left">
											...
											<?if(
												...
												<span class="text_wrap font_14 color-theme" data-coordinates="<?=$arItem['MIDDLE_PROPS']['MAP']['VALUE'];?>">
													<?=CAllcorp3Medc::showIconSvg('on_map fill-theme', SITE_TEMPLATE_PATH.'/images/svg/show_on_map.svg');?>
											...
											<?if($arItem['MIDDLE_PROPS']['METRO']['VALUE']):?>
												<div class="contacts-list__item-metro">
													<?foreach((array)$arItem['MIDDLE_PROPS']['METRO']['VALUE'] as $metro):?>
														<div class="contacts-list__item-metro__value"><?=CAllcorp3Medc::showIconSvg('metro', SITE_TEMPLATE_PATH.'/images/svg/Metro.svg');?><span class="font_14 color_666"><?=$metro?></span></div>
													<?endforeach;?>
												</div>
											<?endif;?>

											<?if($arItem['MIDDLE_PROPS']['SCHEDULE']['VALUE']):?>
												<div class="contacts-list__item-schedule"><?=CAllcorp3Medc::showIconSvg('schedule', SITE_TEMPLATE_PATH.'/images/svg/Schedule.svg');?><span class="font_14 color_666"><?=$arItem['MIDDLE_PROPS']['SCHEDULE']['~VALUE']['TEXT']?></span></div>
											<?endif;?>
