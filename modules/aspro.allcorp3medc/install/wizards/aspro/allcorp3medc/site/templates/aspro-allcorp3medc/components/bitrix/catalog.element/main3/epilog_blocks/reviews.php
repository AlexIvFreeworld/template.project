...
<?if($templateData['REVIEWS']['VALUE'] && $templateData['REVIEWS']['IBLOCK_ID']):?>
    <?if(!isset($html_reviews)):?>
        ...
        $bCheckAjaxBlock = CAllcorp3Medc::checkRequestBlock("reviews-list-inner");
        ?>
        <?ob_start();?>
        <?$APPLICATION->IncludeComponent(
			...
			array(
				...
				"IS_AJAX" => CAllcorp3Medc::checkAjaxRequest() && $bCheckAjaxBlock,

				// params for reviews-list template
				"NAME_LARGE" => false,
				...
				// params for review-list-inner reviews-list template
				// "SHOW_SECTION_NAME" => "N",
				// "LINKED_MODE" => 'Y',
				// "MOBILE_SCROLLED" => false,
				// "ITEMS_OFFSET" => "N",
