...
if($bShowMap){
	...
	<div class="staff-detail__map staff-detail__map--<?=strtolower($typeMap)?> bordered rounded-4" style="display:none;">
		<span class="staff-detail__map__close stroke-theme-hover" title="<?=\Bitrix\Main\Localization\Loc::getMessage('CLOSE_BLOCK')?>"><?=CAllcorp3Medc::showIconSvg('', SITE_TEMPLATE_PATH.'/images/svg/Close.svg')?></span>
