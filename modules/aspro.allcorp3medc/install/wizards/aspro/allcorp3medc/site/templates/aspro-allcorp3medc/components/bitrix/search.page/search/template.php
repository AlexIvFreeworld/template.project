...
<div class="search-page">
	<div class="searchinput">
		...
		<?}?>
			<button class="btn btn-search" type="submit" name="s" value="<?=GetMessage("SEARCH_GO")?>"><?=CAllcorp3Medc::showIconSvg('search', SITE_TEMPLATE_PATH.'/images/svg/Search_black.svg');?></button>
