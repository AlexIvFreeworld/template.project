...
<div class="container">
    <div class="infoUpload">Путь к файлу /upload/1c.xml </div>
    <div>
        <span class="adm-btn-wrap"><input id="dataUpload" type="submit" class="adm-btn" name="set_filter" value="Загрузить данные" title=""></span>
    </div>
    <div id="result" class="resultUpload"></div>
</div>
<script>
    $(document).ready(function() {
        ...
        var sendAjax = function() {
            ...
            let url = '/local/modules/module_bitrix/admin/parser.php';
            // console.log(request);
            $.ajax({
                type: 'POST',
                url: url,
                ...
                success: function(data) {
                    ...
                    if (data == "end") {
                        ...
                        let res = "<span>Выгрузка прошла успешно</span>";
                        $('#result').html(res);
                    } else {
