<?
$MESS["WEBPROSTOR_SMTP_MODULE_NAME"] = "Отправка почты через SMTP";
$MESS["WEBPROSTOR_SMTP_MODULE_DESC"] = "Позволяет перенастроить отправку почты через SMTP";
$MESS["WEBPROSTOR_SMTP_PARTNER_NAME"] = "Студия ВебПростор";
$MESS["WEBPROSTOR_SMTP_PARTNER_URI"] = "https://webprostor.ru/";
