<?
$MESS["WEBPROSTOR_SMTP_ACCESS_DENIED"] = "Доступ к модулю закрыт.";

$MESS["WEBPROSTOR_SMTP_PAGE_TITLE"] = "Написать письмо";
$MESS["WEBPROSTOR_SMTP_PAGE_DESCRIPTION"] = "Данная форма отправляет письмо напрямую с использованием API модуля. Отправка письма из этой формы не гарантирует, что вы успешно настроили работу модуля через почтовые события. Следуйте инструкции по настройке модуля.";
$MESS["WEBPROSTOR_SMTP_TAB_NAME"] = "Отправка письма";
$MESS["WEBPROSTOR_SMTP_TAB_DESCRIPTION"] = "Отправка письма вручную";

$MESS["WEBPROSTOR_SMTP_NOTE_SENDED"] = "Письмо успешно отправлено";
