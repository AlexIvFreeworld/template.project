...
$arAllOptions = array(
	...
	array("clean_up_period", GetMessage("IALEX_IMPORTXML_CLEAN_UP_PERIOD"), "14", array("text", 3)),
	array("queue_limit", GetMessage("IALEX_IMPORTXML_QUEUE_LIMIT"), "5", array("text", 3)),
);
...
<form method="post" action="<?echo $APPLICATION->GetCurPage()?>?mid=<?=urlencode($mid)?>&amp;lang=<?echo LANGUAGE_ID?>">
	...
	<tr>
		<td width="40%" nowrap>
			<label><?=GetMessage("IALEX_IMPORTXML_SMS_SENDER_LINK")?>:</label>
