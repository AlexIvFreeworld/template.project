...
$groupsMain = Array(
	"MAIN" => GetMessage("WEBPROSTOR_CORE_OPTIONS_GROUP_MAIN"),
	//"ADDITIONAL" => GetMessage("WEBPROSTOR_CORE_OPTIONS_GROUP_ADDITIONAL"),
);
$groupsSites = Array(
	"ADDITIONAL" => GetMessage("WEBPROSTOR_CORE_OPTIONS_GROUP_ADDITIONAL"),
);
...
$optionsMain = Array(
	Array(
		...
		'TYPE' => 'TEXTAREA',
		'COLS' => '60',
		'TITLE' => GetMessage("WEBPROSTOR_CORE_OPTION_THIS_SITE_SUPPORT"),
		'SORT' => '0',
	),
);
	...
	switch($arUT["USER_TYPE_ID"])
	{
		...
		case('enumeration'):
			...
			else
			{
				...
				$values = [
					'REFERENCE' => [GetMessage("WEBPROSTOR_CORE_OPTION_SELECT_PLACEHOLDER")],
					'REFERENCE_ID' => ['']
				];
			}
...
$optionsSites[] = Array(
	...
	'GROUP' => "ADDITIONAL",
	'TYPE' => 'CUSTOM',
	'NOTES' => GetMessage("WEBPROSTOR_CORE_OPTION_ADD_ADDITIONAL_OPTION", ["#URL#" => "/bitrix/admin/userfield_edit.php?lang=".LANGUAGE_ID."&ENTITY_ID=WEBPROSTOR_CORE&back_url=%2Fbitrix%2Fadmin%2Fsettings.php%3Flang%3D".LANGUAGE_ID."%26mid%3Dwebprostor.core"]),
	'SORT' => '9999',
);
