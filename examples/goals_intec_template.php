...
<?= Html::beginTag('div', [
    ...
    <?php if (($arResult['ERROR']['CODE'] == 0 || $arResult['ERROR']['CODE'] >= 4) && !$arResult['SENT']) { ?>
        <?= Html::beginForm($APPLICATION->GetCurPageParam(), 'post',['enctype' => 'multipart/form-data']) ?>
            ...
            <div class="startshop-forms-result-new-fields intec-ui-form-fields">
                ...
                <?php } ?>
                <?if($arResult['ID'] == 11):?>
                    <div class="startshop-forms-result-new-field intec-ui-form-field">
                            <label for="file-resume" class="startshop-forms-result-new-title intec-ui-form-field-title">Выберите файл</label>
                            <div class="">
                                <input type="file" id="file-resume" class="" name="file-resume">
                            </div>
                        </div>
                <?endif;?>    
        ...
        <div class="startshop-forms-result-new default">
            <div class="startshop-forms-result-new-wrapper">
                <div class="startshop-forms-result-new-sent">
                    ...
                    <?if(intval( $arResult["ID"]) == 1):?>
                    <script>
                        // console.log("sent OrderCall");
                        ym(95888923, 'reachGoal', 'OrderCall');
                    </script>
                    <?endif;?>
                    <?if(intval( $arResult["ID"]) == 2):?>
                    <script>
                        // console.log("sent RequestPrice");
                        ym(95888923, 'reachGoal', 'RequestPrice');
                    </script>
                    <?endif;?>
                    <?if(intval( $arResult["ID"]) == 9):?>
                    <script>
                        // console.log("sent AskQuestion");
                        ym(95888923, 'reachGoal', 'AskQuestion');
                    </script>
                    <?endif;?>
                </div>
            </div>
