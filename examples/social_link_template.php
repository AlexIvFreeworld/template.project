	...
	<ul>
		...
		<?if(!empty($arResult['SOCIAL_VIBER'])):?>
			<li class="viber viber_mobile">
				<a href="viber://add?number=<?=$arResult['SOCIAL_VIBER']?>" class="dark-color" target="_blank" rel="nofollow" title="<?=GetMessage('TEMPL_SOCIAL_VIBER')?>">
					<?=GetMessage('TEMPL_SOCIAL_VIBER')?>
				</a>
			</li>
			<li class="viber viber_desktop">
				<a href="viber://chat?number=+<?=$arResult['SOCIAL_VIBER']?>" class="dark-color" target="_blank" rel="nofollow" title="<?=GetMessage('TEMPL_SOCIAL_VIBER')?>">
					<?=GetMessage('TEMPL_SOCIAL_VIBER')?>
				</a>
			</li>
		<?endif;?>
		<?if(!empty($arResult['SOCIAL_WHATS'])):?>
			...
			$whatsText = '?text='.rawurlencode($text);
			?>
			<li class="whats">
				<a href="https://wa.me/<?=$arResult['SOCIAL_WHATS']?><?=($bWhatsText ? $whatsText : '')?>" class="dark-color" target="_blank" rel="nofollow" title="<?=GetMessage('TEMPL_SOCIAL_WHATS')?>">
