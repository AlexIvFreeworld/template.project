...
var iSsubmit = function(eventdata){
    //console.log(eventdata.form_name);
    if(eventdata.form_name =="aspro_allcorp2_order_product"){
      //console.log("sent aspro_allcorp2_order_product");
      ym(51271549, 'reachGoal', 'OrderProduct');
    }
    if(eventdata.form_name =="aspro_allcorp2_question"){
      //console.log("sent aspro_allcorp2_question");
      ym(51271549, 'reachGoal', 'AskQuestion');
    }
    if(eventdata.form_name =="aspro_allcorp2_callback"){
      //console.log("sent aspro_allcorp2_callback");
      ym(51271549, 'reachGoal', 'CallBack');
    }
}
